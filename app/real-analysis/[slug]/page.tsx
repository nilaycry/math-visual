...
export async function generateMetadata({
  ...
  return {
    title: `${note.title} - Real Analysis`,
...
export default async function NotePage({
  ...
  return (
    <div
      className="note-accent-real-analysis"
      style={{
        minHeight: "100vh",
        backgroundColor: BG,
        color: FG,
    ...
    >
      ...
      >
        <Link href="/real-analysis" className="co-note-button">
      ...
      >
        ...
        {noteHasProblems && (
          <div style={{ marginTop: 48 }}>
            <Link href={`/real-analysis/${params.slug}/problems`} className="co-note-action">
      ...
      >
        {prevNote ? (
          <Link
            href={`/real-analysis/${prevNote.slug}`}
        ...
        {nextNote ? (
          <Link
            href={`/real-analysis/${nextNote.slug}`}
            className="co-note-nav-card"
